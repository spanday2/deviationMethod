...
class BackwardEuler(Integrator):
   ...
   def BE_system(self, deltaQ_plus, deltaQ, Q_tilda, dt, rhs):
      Q_plus = deltaQ_plus + Q_tilda   
      # print(deltaQ_plus.max())
      return (deltaQ_plus - deltaQ) / dt - [rhs(Q_plus) - rhs(Q_tilda)]
